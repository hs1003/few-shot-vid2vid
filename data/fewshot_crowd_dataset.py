...
class FewshotCrowdDataset(BaseDataset):
    @staticmethod
    def modify_commandline_options(parser, is_train):
        parser.set_defaults(dataroot='datasets/crowd/')
        ...
        ### for inference        
        parser.add_argument('--seq_path', type=str, default='datasets/crowd/test_images/01/',
                            help='path to the driving sequence')
        parser.add_argument('--ref_img_path', type=str, default='datasets/crowd/test_images/02/',
    ...
    def __getitem__(self, index):
        ...
        transform_L = get_transform(opt, img_params, method=Image.NEAREST,
        ...
        seq = path.basename(path.dirname(opt.ref_img_path)) + '-' + opt.ref_img_id + '_' + path.basename(
